...
- **No ML dependency**: The simulation uses interpretable economic heuristics, not black-box models. This is deliberate — explainability matters more than accuracy in a POC.
